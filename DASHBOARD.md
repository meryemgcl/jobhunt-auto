...
> **Son Güncelleme:** `19.09.2026 14:12`  
...
| Metrik | Değer |
|---|---|
| **Son Taramada Analiz Edilen Pozisyon** | `55` |
| **Profil Uyumlu Seçilen Fırsat** | `3` |
...
- **AWS**: 8 ilanda talep edildi
- **GIT**: 3 ilanda talep edildi
- **KUBERNETES**: 3 ilanda talep edildi
